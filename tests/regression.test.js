...
(function () {
  ...
  check('breakdown: tables are headed by the name, not "paid by you"', /Transactions paid by/.test(ppb), false);
  ...
  check('home: Create new sits on the dark blue', /\.create-zone\{[^}]*#1d3557/.test(src), true);
